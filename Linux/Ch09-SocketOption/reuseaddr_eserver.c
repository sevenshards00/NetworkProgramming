...
* 파일명: reuseaddr_eserver.c
* 파일 버전: 0.1
* 작성자: Sevenshards
* 작성 일자: 2023-12-20
* 이전 버전 작성 일자:
* 버전 내용: Linux 기반 SO_REUSEADDR과 Time-wait 상태 확인 예제
* 이전 버전 내용:
*/

// 기존의 echo_server.c 코드를 그대로 사용
// 일부 추가만 되었음
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(int argc, char* argv[])
{
    ...
    socklen_t optlen, clnt_addr_sz; // 클라이언트의 주소 값의 크기
